...
# ---
super_page.add_Usertables(User_tables_cx, "toolforge")
catdepth_new.add_Usertables(User_tables_cx, "toolforge")
# ---
...
def medwiki_cat_members(cat="Category:Mdwiki Translation Dashboard articles"):
    ...
    # ---
    cat_members = CatDepth(cat, sitecode="mdwikicx", family="toolforge", depth=0, ns="all", nslist=[], without_lang="", with_lang="", tempyes=[])
