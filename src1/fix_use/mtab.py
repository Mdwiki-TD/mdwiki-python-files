...
python3 core8/pwb.py fix_use/mtab path:I:/MD_TOOLS/MDWIKI_MAIN_REPO/public_html/td2/actions
python3 core8/pwb.py fix_use/mtab path:I:/MD_TOOLS/MDWIKI_MAIN_REPO/public_html/td2/enwiki
...
tab = {
    ...
    "WikiParse\\Citations": ["get_name", "getCitations", "get_full_refs", "get_short_refs"],
