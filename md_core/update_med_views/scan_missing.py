...
python3 core8/pwb.py update_med_views/scan_missing is_zero
python3 core8/pwb.py update_med_views/scan_missing
...
from update_med_views.views import get_view_file
