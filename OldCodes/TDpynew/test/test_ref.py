...
<!-- Cause and diagnosis -->
Causes include [[Sheehan's syndrome|Sheehan syndrome]], [[pituitary surgery]], [[traumatic brain injury]], and certain [[genetic mutations]].<ref name=Yen2013>{{cite book|author1=Jerome F. Strauss III|author2=Robert L. Barbieri|title=Yen & Jaffe's Reproductive Endocrinology: Physiology, Pathophysiology, and Clinical Management|url=https://books.google.com/books?id=TTCwAAAAQBAJ&pg=PA53|date=28 August 2013|publisher=Elsevier Health Sciences|isbn=978-1-4557-5972-9|pages=53–}}</ref><ref name=Bond2005>{{cite journal |last1=Bondanelli |first1=M |last2=Ambrosio |first2=MR |last3=Zatelli |first3=MC |last4=De Marinis |first4=L |last5=degli Uberti |first5=EC |title=Hypopituitarism after traumatic brain injury. |journal=European journal of endocrinology |date=May 2005 |volume=152 |issue=5 |pages=679-91 |doi=10.1530/eje.1.01895 |pmid=15879352}}</ref><ref name=Tri2019/> Diagnosis is by blood tests for prolactin, after being given [[thyrotropin]].<ref name=Mer2021>{{cite web |title=Hypopituitarism - Hormonal and Metabolic Disorders |url=https://www.merckmanuals.com/home/hormonal-and-metabolic-disorders/pituitary-gland-disorders/hypopituitarism |website=Merck Manuals Consumer Version |accessdate=2 February 2021}}</ref><ref name=Emed2021Diag>{{cite web |title=Prolactin Deficiency Workup |url=https://emedicine.medscape.com/article/124526-workup |website=Emedicine |accessdate=2 February 2021}}</ref> Confirming the diagnosis; however, is not necessarily required as there is no specific treatment.<ref name=Emed2021Diag/>

<!-- Treatment and epidemiology -->
While some evidence supports the use of [[prolactin|recombinant human prolactin]], it is not currently approved for medical use.
<ref   name=  'Tri2019"/ ><ref>{{cite web |title=Prolactin Deficiency Medication: Antidopaminergic agents |url=https://emedicine.medscape.com/article/124526-medication |website=emedicine.medscape.com |accessdate=2 February 2021}}</ref> Treatment generally involves [[formula feeding]] the baby.<ref name=Emed2021Tx>{{cite web |title=Prolactin Deficiency Treatment & Management: Medical Care, Consultations |url=https://emedicine.medscape.com/article/124526-treatment |accessdate=2 February 2021 |date=9 November 2019}}</ref> Prolactin deficiency alone is rare.
