...
ids_to_work = {urls_to_ids.get(url): jsons.all_ids.get(urls_to_ids.get(url)) for url in t_to_work if urls_to_ids.get(url) and jsons.all_ids.get(urls_to_ids.get(url))}
