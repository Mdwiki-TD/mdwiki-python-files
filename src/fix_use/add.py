...
python3 core8/pwb.py fix_use/add path:I:/MD_TOOLS/MDWIKI_MAIN_REPO/public_html/td2/actions
python3 core8/pwb.py fix_use/add path:I:/MD_TOOLS/MDWIKI_MAIN_REPO/public_html/td2/enwiki
