...
class PageRecord(Base):
    ...
    add_date: Mapped[datetime] = mapped_column(nullable=False, server_default=func.current_timestamp())
...
class PagesUsersToMainRecord(Base):
    """
