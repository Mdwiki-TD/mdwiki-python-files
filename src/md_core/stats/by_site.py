...
python3 core8/pwb.py md_core/stats/by_site
tfj run stats2 --image python3.9 --command "$HOME/local/bin/python3 core8/pwb.py md_core/stats/by_site"
...
from md_core.stats.editors import get_editors, validate_ip
